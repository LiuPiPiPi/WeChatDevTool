package com.lpxz.wechatdevtool.utils;

import com.lpxz.wechatdevtool.constant.AccessToken;
import com.lpxz.wechatdevtool.menu.Menu;
...
/**
 * @author LPxz
 * @since 2021-10-12 10:04
 */
public class CommonWechatUtil {
    private static final Logger log = LoggerFactory.getLogger(CommonWechatUtil.class);
    // 凭证获取（GET）
